...
// Global operators
// ============
mw::Tap operator* (const mw::Tap&, const mw::Tap&);
mw::Tap operator+ (const mw::Tap&, const mw::Tap&);
mw::Tap operator- (const mw::Tap&, const mw::Tap&);
mw::Tap operator/ (mw::Tap, mw::Tap);
mw::Tap operator% (const mw::Tap&, const mw::Tap&);
bool operator> (const mw::Tap&, const mw::Tap&);
bool operator< (const mw::Tap&, const mw::Tap&);
bool operator== (const mw::Tap&, const mw::Tap&);
bool operator!= (const mw::Tap&, const mw::Tap&);
...
bool is_equal(const mw::Tap&, const mw::Tap&);                   /// @test
mw::Tap addv2 (const mw::Tap&, const mw::Tap&);                 /// @test
